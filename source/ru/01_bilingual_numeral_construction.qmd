---
title: Конструкции с числительными в билингвальной речи
...
Конструкции с числительными в русском языке имеют сложный синтаксис, поэтому в речи билингвов часто используются нестандартные конструкции, например, *три месяц*, *тринадцать девчонки*.
