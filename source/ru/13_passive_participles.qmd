...
Страдательные причастия прошедшего времени в русском языке образуются с помощью суффиксов -*н*-/-*т*- (*построенный*). В диалектах наряду с ними используются нестандартные формы с суффиксом -*ши* (*построивши*).
