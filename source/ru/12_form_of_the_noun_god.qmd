---
title: Форма существительного *год*
author: Светлана Земичева
date: 'Last update: `r lubridate::make_datetime(year = 2025, month = 4, day = 15)`'
output:
  html_document:
...
Форма существительного *год* в родительном падеже множественного числа (*лет* или *годов*).
