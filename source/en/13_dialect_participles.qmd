...
Standard past participles in Russian are formed using the suffixes -*н* / -*т* (*построенный*, *умерший*). In dialects, alongside  these, non-standard forms with the suffix -*ши* (*построивши*, *умерши*) are also used. The first type (*построивши*) is derived  from transitive verbs; the second type (*умерши*) is derived from intransitive verbs.
