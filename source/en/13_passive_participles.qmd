...
Passive past participles in Russian are formed using the suffixes -*н* / -*т*: *построенный* – postroennyj (built). In dialects, alongside these, non-standard forms with the suffix -*ши* are also used: *построивши* postroivši (built)
