---
title: Bilingual Numeral construction
...
Numeral constructions in Russian have a complex syntax, so bilinguals often use non-standard constructions, for  example, *три месяц*, *тринадцать девчонки*.
