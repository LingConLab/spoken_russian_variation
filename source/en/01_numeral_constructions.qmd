...
Numeral constructions in Russian have a complex syntax, so bilinguals often use non-standard constructions, for example, *три месяц* *tri mesjac(Nom)* – standard *tri mesjaca(Gen)* (three months) (Karel-Russian bilingual)
