...
author: Maiia Alimova, Anna Grishanova, Natalia Koshelyuk, Anastasia Yakovleva
date: 'Last update: `r lubridate::make_datetime(year = 2025, month = 6, day = 27)`'
output:
  html_document:
...
As in *голове не держится* (Cant keep _in_ mind) (Chuvash-Russian bilingual).
